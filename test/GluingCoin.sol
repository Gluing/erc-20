...
describe("Gluing Coin contract", () => {
    ...
    beforeEach(async () => {
        ...
        token = await GluingCoin.deploy(owner.address, supplyWithDecimals);
    })
    ...
    context("Minting", () => {
        ...
        beforeEach(async () => {
            ...
            token = await GluingCoin.deploy(owner.address, 0);
        });
